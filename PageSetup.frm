...
Printer.FontSize = frmMain.txtBox.FontSize
...
If gblnChangeMarges = True Then
    ...
    End If
If Me.chkPrint.Value = 1 Then
    tmp = "Memo van " & frmMain.txtDate.Text & " " & Me.txtPrintHead.Text & vbCrLf & vbCrLf & frmMain.txtBox.Text
    Else
